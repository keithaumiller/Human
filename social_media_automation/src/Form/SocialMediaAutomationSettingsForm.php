...
class SocialMediaAutomationSettingsForm extends ConfigFormBase {
  ...
  protected function addPlatformCredentialFields(array &$form_section, $platform, $config, $platform_name) {
    ...
    switch ($platform_name) {
      case 'mastodon':
        ...
        $form_section['username'] = [
          '#type' => 'textfield',
          '#title' => $this->t('Username'),
          '#default_value' => $config->get($platform_name . '.username'),
          '#description' => $this->t('Your Mastodon username (without @) for mention monitoring'),
          '#placeholder' => 'yourusername',
          '#id' => 'edit-mastodon-username',
        ];
  ...
  protected function buildSocialMediaPrompt($article_title, $article_url, $motivation_analysis) {
    $prompt = "Create a compelling social media post for Mastodon based on the motivation analysis below. Focus heavily on SPORTS angles and trending sports topics.\n\n";
    ...
    $prompt .= "- Use phrases like 'Let me tell you something', 'This is RIDICULOUS', 'I'm telling you right now'\n";
    ...
    $prompt .= "- Make it engaging while maintaining passionate sports commentary approach\n\n";
