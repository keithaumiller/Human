...
class ContentGenerator {
  ...
  public function generateRecentArticle(): string {
    try {
      ...
      $templates = [
        "Random Deep Dive: \"{$title}\" - Our AI analysis reveals the underlying motivational patterns in this story. {$motivation_insight}",
  ...
  public function generateBiasInsight(): string {
    $insights = [
      ...
      "Black Box Problem: AI systems that rank and rate news operate without transparency. Those who control the algorithms effectively control how information is perceived. We're exposing these limitations.",
