...
The social media automation module now automatically posts to Mastodon (and other enabled platforms) **nine times per day** during optimal engagement hours throughout the day. The system rotates through different content types to provide variety and maintain audience engagement.

## How It Works

### 1. **Cron Schedule**
- **Early Morning Window**: 6 AM - 8 AM (2-hour window)
- **Morning Window**: 8 AM - 10 AM (2-hour window)
- **Mid-Morning Window**: 10 AM - 12 PM (2-hour window)
- **Noon Window**: 12 PM - 2 PM (2-hour window)
- **Afternoon Window**: 2 PM - 4 PM (2-hour window)
- **Late Afternoon Window**: 4 PM - 6 PM (2-hour window)
- **Evening Window**: 6 PM - 8 PM (2-hour window)
- **Late Evening Window**: 8 PM - 10 PM (2-hour window)
- **Night Window**: 10 PM - 12 AM (2-hour window)
- **Frequency**: Nine times per day
- **Time Zone**: Server time (production server timezone)

### 2. **Content Rotation by Time Window**
**Early Morning Posts (6-8 AM):**
...
**Afternoon Posts (2-4 PM):**
- **recent_article** - Features the most recent article with AI motivation analysis
- **analytics_summary** - Daily statistics and insights

**Late Afternoon Posts (4-6 PM):**
- **trending_topics** - Popular themes from recent articles
- **bias_insight** - AI bias detection insights and platform transparency
...
**Late Evening Posts (8-10 PM):**
- **trending_topics** - Popular themes from recent articles
- **bias_insight** - AI bias detection insights and platform transparency

**Night Posts (10 PM-12 AM):**
- **recent_article** - Features the most recent article with AI motivation analysis
- **analytics_summary** - Daily statistics and insights
...
3. Ensure current time is within one of the posting windows (6 AM - 12 AM)
4. Check if post was already sent today for the current time window
