...
class AIProcessingService {
  ...
  public function generateAnalysis($article_text, $article_title) {
    if (!\Drupal::state()->get('ai_calls_enabled', TRUE)) {
      $this->logger()->info('AI calls disabled — skipping analysis for: @title', ['@title' => $article_title]);
      return NULL;
    }
  ...
  protected function buildAnalysisPrompt($article_title, $article_text) {
    ...
    return "Analyze this article with the passion and energy of a sports broadcaster! Focus heavily on SPORTS angles, athletic metaphors, and competitive dynamics.\n\n" .
           "Instructions:\n" .
           ...
           "4. Provide analysis of how this affects that metric using SPORTS LANGUAGE and athletic metaphors\n" .
           ...
           "- Use bold, passionate, emphatic language like a sports commentator\n" .
           "- Connect stories to sports themes, competition, winning/losing, team dynamics\n" .
           "- Use phrases like 'Let me tell you something', 'This is RIDICULOUS', 'I'm telling you right now'\n" .
           "- Frame political/business moves as athletic strategies and competitive plays\n" .
           "- Describe entities as 'players', 'teams', 'coaches', 'competitors' when appropriate\n" .
           "- Use sports metaphors: 'stepping up to the plate', 'fourth quarter moves', 'championship mentality'\n\n" .
           ...
           "  \"analysis\": \"Let me tell you something - this story is HUGE! [Use passionate sports broadcaster style with athletic metaphors and competitive language].\",\n" .
